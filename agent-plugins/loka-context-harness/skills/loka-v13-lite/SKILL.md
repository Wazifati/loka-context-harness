---
name: loka-v13-lite
description: Apply the original LokaV13 Lite v13.2 compact prompt for prompt-driven visual builders and vibe-coding environments.
---

# LokaV13 Lite Agent Skill

Use this compact original V13.2 edition for visual builders and vibe-coding environments. It is an alternative to Full V13. After export to a normal repository or IDE, stop V13 and move to V11.
