---
name: loka-v10-lite
description: Apply the original LokaV10 Lite compact prompt for planning, prompt architecture, or audits without repository or shell execution.
---

# LokaV10 Lite Agent Skill

Use this compact original V10 edition when a user wants a one-page prompt for planning or auditing without live repository or shell work. It is an alternative to Full V10; use V11 instead for a repository-capable Agent.
